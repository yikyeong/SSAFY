    ...
    <div class="modal-overlay" @click.self="$emit('close')">
      <div class="modal-window">
        <div class="review-item">
          ...
          <hr>
          <form @submit.prevent="vueCreateReview">
            <input type="text" v-model="title" placeholder="제목을 입력하세요">
            <input type="textarea" v-model="content" placeholder="내용을 입력하세요, 영화와 상관없는 내용은 약관에 의해 제재를 받을 수 있습니다.">
  ...
  methods: {
    ...
    vueCreateReview() {
      if (!this.title) {
        ...
        this.createReview({movieId: this.movie.id, review: review})
        this.$emit('close')
      }
    }
  }
